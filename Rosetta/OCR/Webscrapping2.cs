    ...
    public static class WebScrapper
    {
        ...
        public static string NaiveMouser(string keyword)
        {
            ...
            using (WebClient wc = new WebClient())
            {
                ...
                System.Threading.Thread.Sleep(10000);
                HtmlElement a = wb.Document.GetElementById("ct100_ContentMain_SearchResultsGrid_grid");
                
                //a = a.FirstChild;
                HtmlElementCollection data_row_results = a.Children;
                HtmlElementCollection tr_tags = a.GetElementsByTagName("TR");
                HtmlElement b;

                System.Threading.Thread.Sleep(10000);
                // Iterate through valid data, return first description
                foreach (HtmlElement e in tr_tags)
                {
                    if (e.GetAttribute("className") == "SearchResultsRowOdd")
                    {
                        b = e;
                        b = b.FirstChild;
                        System.Threading.Thread.Sleep(10000);
